...
- **编辑器验证**：在 cfgeditor 图形界面中实时查看检测结果，适合开发过程中使用（详见[编辑器功能介绍 - 未引用记录检测](/cfgeditor/overview#未引用记录检测)）
...
- [命令行工具](/cfggen/usage) - 了解更多命令行参数和用法
- [元数据配置](/cfggen/othermetadatas) - 了解 `(root)` 元数据配置
- [外键关联](/cfggen/key) - 了解外键的定义和使用
- [配置编辑器功能介绍](/cfgeditor/overview) - 在图形界面中使用验证功能
- [最佳实践](/cfggen/bestpractices) - 了解配置开发的最佳实践
