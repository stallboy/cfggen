...
![ai setting](aigen/aiSetting.png)
...
![ai gen](aigen/aiGen.png)

**详细指南**:
- [AI 功能概览](/aigen/overview) - AI 生成功能的完整介绍
- [AI 配置指南](/aigen/mcpserver) - Claude Code 集成和高级用法
- [Schema 生成](/aigen/schema-gen) - 使用自然语言生成 CFG Schema 定义文件
...
- [配置编辑器功能介绍](/cfgeditor/overview) - 可视化配置编辑器，提供图形化界面查看和编辑配置

### 2️⃣ 深入结构定义

- [结构定义详解](/cfggen/schema) - 学习 struct、interface、table 的完整语法
- [主键、枚举、外键](/cfggen/key) - 理解数据关联和引用
- [映射到表格](/cfggen/tabularmapping) - Excel 单元格如何映射到复杂数据结构

### 3️⃣ 高级功能

- [标签系统](/cfggen/tag) - 客户端/服务器数据分离
- [国际化支持](/cfggen/i18n) - 多语言配置
- [AI 生成配置](/aigen/overview) - 使用 AI 自动生成配置数据
