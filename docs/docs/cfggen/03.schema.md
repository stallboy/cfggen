...
> 详细主键、唯一键说明请参考：[主键、枚举、外键](04.key.md)
...
> 详细映射规则请参考：[映射到表格](05.tabularMapping.md)
...
- **文件目录结构**：详见 [文件目录结构](02.directoryStructure.md)
- **表键与关联**：详见 [表键、枚举与数据关联](04.key.md)
- **表格映射**：详见 [映射到表格](05.tabularMapping.md)
