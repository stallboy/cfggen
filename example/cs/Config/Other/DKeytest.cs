...
public partial class DKeytest
{
    ...
    private static OrderedDictionary<Id1Id2Key, DKeytest> _all = [];
    ...
    private static OrderedDictionary<Id1Id3Key, DKeytest> _id1Id3Map = [];
    ...
    private static OrderedDictionary<long, DKeytest> _id2Map = [];
    ...
    private static OrderedDictionary<Id2Id3Key, DKeytest> _id2Id3Map = [];
