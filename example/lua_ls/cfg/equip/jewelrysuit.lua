...
local mk = cfg._mk.i18n_table(this, { { 'all', 'get', 1 }, }, 2, nil, 
    { name = 1 },
    'suitID', -- int, 饰品套装ID
    'ename', -- str
    'name', -- text, 策划用名字
...
mk(1, "", 2, 3, 750, 2, 40, 6, 222, R({10, 35, 60, 85}))
mk(2, "", 3, 2, 40, 3, 1200, 1, 123, R({14, 39, 64, 89}))
mk(3, "", 4, 3, 1600, 4, 135, 6, 398, R({15, 40, 65, 90}))
mk(4, "SpecialSuit", 5, 2, 54, 3, 1800, 1, 186, R({19, 44, 69, 94}))
mk(5, "", 6, 3, 2600, 4, 226, 6, 556, R({20, 45, 70, 95}))
mk(6, "", 7, 2, 70, 3, 2900, 1, 243, R({24, 49, 74, 99}))
mk(7, "", 8, 3, 3800, 4, 286, 6, 711, R({25, 50, 75, 100}))
