...
func (t *AiAi_condition) String() string {
    return fmt.Sprintf("AiAi_condition{iD=%v, desc=%v, formulaID=%v, argIList=%v, argSList=%v}", t.iD, t.desc, t.formulaID, fmt.Sprintf("%v", t.argIList), fmt.Sprintf("%v", t.argSList))
}
