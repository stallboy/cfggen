...
func (t *OtherLootitem) String() string {
    return fmt.Sprintf("OtherLootitem{lootid=%v, itemid=%v, chance=%v, countmin=%v, countmax=%v}", t.lootid, t.itemid, t.chance, t.countmin, t.countmax)
}
