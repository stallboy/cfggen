...
export class Text
{
    private _zh_cn: string = "";
    get zh_cn(): string { return this._zh_cn; }
    private _en: string = "";
    get en(): string { return this._en; }
    private _tw: string = "";
    get tw(): string { return this._tw; }
    static _create(os: Stream): Text
    {
        const self = new Text();
        const texts = os.ReadTextsInPool();
        self._zh_cn = texts[0];
        self._en = texts[1];
        self._tw = texts[2];
        return self;
    ...
    toString(): string {
        return "(" + this._zh_cn + "," + this._en + "," + this._tw + ")";
    }
}
