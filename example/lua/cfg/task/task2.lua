...
mk(1, {"测试用"}, 2, conditionand(conditionand(killmonster(1, 0), collectitem(0, 0)), talknpc(0)), 10001, true, "", position(1, 0, 0), {12}, {position(1, 2, 3)}, {constvalue(1234)})
mk(2, {"和npc对话", "和npc对话"}, 3, A[2], 2000, false, "", A[4], E, E, E)
mk(3, {"收集物品", "收集物品"}, 0, A[3], 3000, false, "", A[4], E, E, E)
mk(4, {"杀怪并且收集物品", "杀怪并且收集物品"}, 0, conditionand(A[1], A[3]), 4000, false, "", A[4], E, E, E)
mk(5, {"杀怪对话并且收集物品", "杀怪对话并且收集物品"}, 0, conditionand(conditionand(A[1], A[2]), A[3]), 5000, false, "", A[4], E, E, E)
mk(6, {"聊天并且杀怪", "测试转义符号"}, 0, conditionand(chat("葵花宝典,123"), A[1]), 5000, false, "", A[4], E, E, E)
mk(7, {"测试", "测试无参数得bean"}, 0, A[5], 2000, false, "", A[4], E, E, E)
mk(8, {"测试2", "测试默认bean"}, 0, A[5], 3000, false, "", A[4], E, E, E)
