...
mk(1, "受到伤害", 1, E, E)
mk(2, "血量20%到80%", 2, {20, 80}, E)
mk(10012, "游戏开始召唤猴子", 6, A[1], E)
mk(10013, "游戏开始召唤猩猩", 6, A[1], E)
mk(1017001, "出生后30秒", 6, {900}, E)
mk(1017007, "出生后", 6, {5}, E)
mk(1018001, "出生后60秒", 6, A[2], E)
mk(5004001, "出生后", 6, A[1], E)
mk(5004002, "出生后1分", 6, A[2], E)
mk(5004003, "出生后2分", 6, {3600}, E)
mk(5004004, "出生后3分", 6, {5400}, E)
mk(200501, "出生后一帧", 6, {15}, E)
mk(103011, "出生后的瞬间", 6, {1}, E)
mk(20801, "游戏开始召唤猩猩", 6, A[1], E)
mk(20017, "出生后3秒", 6, {90}, E)
mk(20020, "血量低于40%", 3, {40}, E)
mk(20021, "死亡", 8, E, E)
mk(200201, "出生后10秒", 6, {300}, E)
