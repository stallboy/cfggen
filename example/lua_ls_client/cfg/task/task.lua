...
mk(1, R({22, 23}), 2, A[1], 1000, A[4])
mk(2, R({24, 25}), 3, A[2], 2000, testdefaultbean(22, false, "text", position(3, 4, 5), R({11, 22}), R({3, 4, 5}), R({[1] = "str in map"})))
mk(3, R({26, 27}), 0, A[3], 3000, A[4])
mk(4, R({28, 29}), 0, conditionand(A[1], A[3]), 4000, A[4])
mk(5, R({30, 31}), 0, conditionand(conditionand(A[1], A[2]), A[3]), 5000, A[4])
mk(6, R({32, 33}), 0, conditionand(chat("葵花宝典,123"), A[1]), 5000, A[4])
mk(7, R({34, 35}), 0, A[5], 2000, A[4])
mk(8, R({36, 37}), 0, A[5], 3000, A[4])
