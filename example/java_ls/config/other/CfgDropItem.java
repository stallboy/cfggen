...
public class CfgDropItem {
    ...
    public CfgDropItem(int chance, java.util.List<Integer> itemids, int countmin, int countmax) {
        this.chance = chance;
    ...
    public static CfgDropItem _create(configgen.genjava.ConfigInput input) {
        CfgDropItem self = new CfgDropItem();
    ...
    public boolean equals(Object other) {
        if (!(other instanceof CfgDropItem))
            return false;
        CfgDropItem o = (CfgDropItem) other;
