java --enable-preview -Dfile.encoding=utf8 -jar ../app/build/libs/configgen.jar -datadir config -gen java,dir:java,sealed,builders:config/builders.txt -gen javadata
