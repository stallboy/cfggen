...
static func create(stream: ConfigStream) -> DataTask_Taskextraexp:
	...
	instance.test1 = stream.get_string()
	instance.test2 = stream.get_string()
	instance.fielda = stream.get_string()
	instance.fieldb = stream.get_string()
	instance.fieldc = stream.get_string()
	instance.fieldd = stream.get_string()
	return instance
