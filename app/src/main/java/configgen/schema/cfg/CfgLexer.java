...
public class CfgLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"RB", "LC", "RC", "DOT", "COMMA", "COLON", "PLUS", "MINUS", "DECIMAL_DIGIT", 
			"HEXADECIMAL_DIGIT", "ESCAPE_SEQUENCE", "SIMPLE_ESCAPE_SEQUENCE", "HEXADECIMAL_ESCAPE_SEQUENCE", 
			"UNICODE_ESCAPE_SEQUENCE", "STRING_CONSTANT", "SCHAR_SEQUENCE", "SCHAR", 
			"INTEGER_CONSTANT", "HEX_INTEGER_CONSTANT", "FLOAT_CONSTANT", "FLOATLIT", 
			"DECIMALS", "EXPONENT", "WS"
		};
	}
